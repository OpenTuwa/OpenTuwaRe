...
export default function Legal() {
  ...
  // 2. Table of Contents Data (Moved out of HTML logic into clean data)
  const tocData = {
    eua: [
  ...
  // 3. Effects for standard browser behaviors
  useEffect(() => {
  ...
  // Check if mobile scroll indicator is needed
  ...
  const handleLanguageChange = (lang) => {
    setCurrentLang(lang);
    setIsLangDropdownOpen(false);
    // If you are using your i18n.js, it can hook into this state or localStorage
